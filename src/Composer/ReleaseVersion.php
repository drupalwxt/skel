...
namespace Drupal\skel\Composer;

use Drupal\skel\IniEncoder;
use Composer\Script\Event;
use Symfony\Component\Finder\Finder;
use Symfony\Component\Yaml\Yaml;

/**
 * Updates the version number in Skel's component info files.
 */
class ReleaseVersion {
  ...
  public static function execute(Event $event) {
    ...
    // Find all .info files in Skel...except in the installed code base.
    $finder = (new Finder())
      ->name('*.info.yml')
      ->in('.')
      ->exclude('html');
